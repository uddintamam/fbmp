...
Public Class PostFBLiteControl
...
#Region "Event Control"
    ...
    Private Sub PostFBLiteControl_Load(sender As Object, e As EventArgs) Handles MyBase.Load
...
#End Region
            Try
                runRobot(cbxDataProfile.Text, category, chkRunAllProfile.Checked)
    ...
    Private Sub runRobot(profileName As String, category As String, isRunAll As Boolean)
    ...
    Private Sub runRobotWork(foundRows As DataRow(), category As String, isRunAll As Boolean)
...
#Region "Proses membuka browser dan inject element ke dalam threads"
            ...
            If existingProfile Is Nothing Then
                ...
                If isRunAll Then
                    ...
                    Thread.Sleep(1000)
                Else
                    PostingLiteFb(foundRow, category, fieldList)
                End If
...
#End Region
    ...
    Private Sub PostingLiteFb(dataProfile As DataRow, categoryProd As Integer, fieldList As List(Of String()))
        ...
        Try
            ...
            existingProfile = baseForm.runChromeLiteDriver(profileName, userId)
            '========================================
...
#Region "Mulai membuka halaman facebook.com"
            ...
            Try
                ...
                statusPost = existingProfile.CheckLoginLiteProcess(dataProfile)
                '=============================================
                WaitHandle.WaitAny({suspendEvent})
...
#Region "Proses input Data berdasarkan CSV di teruskan ke Class ChromeProfile"
                    postStatus =
                                    existingProfile.PostFBLite(jedarandom, fields, waitforelement,
                                                        categoryProd, Me.gridProfile, userId, current, jmlBaris, suspendEvent)
#End Region
