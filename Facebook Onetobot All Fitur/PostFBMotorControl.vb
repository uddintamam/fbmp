...
Public Class PostFBMotorControl
    ...
    Public Sub New(fiturPostFB As FiturPostFBEnum)
        ...
        Select Case _fiturPostFB
            Case FiturPostFBEnum.General
                lblHeader.Text = "FITUR AUTO POST FBMP MOTOR BIASA"
                'btnStartProcess.Text = "START ROBOT POST MOTOR BIASA"
            Case FiturPostFBEnum.OnlyDraft
                lblHeader.Text = "FITUR AUTO POST FBMP MOTOR DRAF"
                'btnStartProcess.Text = "START ROBOT POST MOTOR DRAF"
            Case FiturPostFBEnum.DraftAndPost
                lblHeader.Text = "FITUR AUTO POST FBMP MOTOR ANTI DUPLIKAT"
                'btnStartProcess.Text = "START ROBOT POST MOTOR ANTI DUPLIKAT"
        End Select
    ...
    Private Sub PostFBMotorControl_Load(sender As Object, e As EventArgs) Handles MyBase.Load
...
#Region "Validasi sebelum menjalankan proses"
            ...
            If String.IsNullOrEmpty(merek) Then
                MessageBox.Show("Merek Motor belum dipilih.", "Kesalahan", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                doubleClickOccurred = False
                Return
            End If
            ...
            If warna < 0 Then
                MessageBox.Show("Warna Ekterior Motor belum dipilih.", "Kesalahan", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                doubleClickOccurred = False
                Return
            End If
            ...
            If fuel < 0 Then
                MessageBox.Show("Bahan Bakar Motor belum dipilih.", "Kesalahan", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                doubleClickOccurred = False
                Return
            End If
            ...
            If transmission < 0 Then
                MessageBox.Show("Transmisi Motor belum dipilih.", "Kesalahan", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                doubleClickOccurred = False
                Return
            End If
...
#End Region
            ...
            Try
                runRobot(cbxDataProfile.Text, tahun, merek, warna, fuel, transmission, chkRunAllProfile.Checked)
    ...
    Private Sub runRobot(profileName As String, tahun As Integer, merek As String, warna As Integer, fuel As Integer, transmission As Integer, isRunAll As Boolean)
    ...
    Private Sub runRobotWork(foundRows As DataRow(), tahun As Integer, merek As String, warna As Integer, fuel As Integer, transmission As Integer, isRunAll As Boolean)
...
#End Region
    ...
    Private Sub PostingLiteFb(dataProfile As DataRow, tahun As Integer, merek As String,
                              warna As Integer, fuel As Integer, transmission As Integer,
            ...
            Try
                ...
                For i As Integer = nilaiAwal To nilaiAkhir
                    ...
                    Select Case _fiturPostFB
                        Case FiturPostFBEnum.General
                            postStatus =
                                    existingProfile.PostMotorFB(jedarandom, fields, waitforelement,
                                                        tahun, merek, warna, fuel, transmission,
                                                                Me.gridProfile, userId, current, jmlBaris, suspendEvent)
                        Case FiturPostFBEnum.OnlyDraft
                            postStatus =
                                    existingProfile.PostMotorOnlyDraftFB(jedarandom, fields, waitforelement,
                                                    tahun, merek, warna, fuel, transmission,
                                                    Me.gridProfile, userId, current, jmlBaris, suspendEvent)
                        Case FiturPostFBEnum.DraftAndPost
                            postStatus =
                                existingProfile.EditMotorFromDraftFB(jedarandom, fields, waitforelement,
                                                                    tahun, merek, warna, fuel, transmission,
                                                                        Me.gridProfile, userId, current, jmlBaris, suspendEvent)
                            'End If
                    End Select
