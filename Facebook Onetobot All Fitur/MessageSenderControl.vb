...
Public Class MessageSenderControl
    ...
    Private Sub MessageSenderControl_Load(sender As Object, e As EventArgs) Handles MyBase.Load
...
#Region "Validasi sebelum menjalankan proses"
            ...
            If String.IsNullOrEmpty(txtMessage.Text) Then
                MessageBox.Show("Pesan belum diisi", "Kesalahan", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                doubleClickOccurred = False
                Return
            End If
#End Region
            ...
            Try
                runRobot(cbxDataProfile.Text, txtMessage.Text, chkRunAllProfile.Checked)
    ...
    Private Sub runRobot(profileName As String, txtMessage As String, isRunAll As Boolean)
    ...
    Private Sub runRobotWork(foundRows As DataRow(), txtMessage As String, isRunAll As Boolean)
...
#Region "Proses membuka browser dan inject element ke dalam threads"
            ...
            If existingProfile Is Nothing Then
                If isRunAll Then
                    Task.Run(Sub() PostingLiteFb(foundRow, fieldList, txtMessage))
                    Thread.Sleep(1000)
                Else
                    PostingLiteFb(foundRow, fieldList, txtMessage)
                End If
            Else
                MessageBox.Show(
...
#End Region
        Next
    End Sub
    Private Sub PostingLiteFb(dataProfile As DataRow, fieldList As List(Of String()), txtMessage As String)
        ...
        Try
            ...
            Try
                ...
                For i As Integer = nilaiAwal To nilaiAkhir
                    ...
                    postStatus = existingProfile.SendMessageMemberGroup(jedarandom, fields, waitforelement, Me.gridProfile, userId, txtMessage, current, jmlBaris, suspendEvent)
                    WaitHandle.WaitAny({suspendEvent})
